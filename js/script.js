const gastos = [
    { mes: 'janeiro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'fevereiro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'marco', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'abril', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'maio', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'junho', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'julho', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'agosto', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'setembro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'outubro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'novembro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
    { mes: 'dezembro', categorias: { energia: 0, agua: 0, aluguel: 0, escola: 0, supermercado: 0 } },
];
...
function criaCardGasto(mesEncontrado, categoriaGasto, valor) {
    const categoriaLabel = document.querySelector(`option[value="${categoriaGasto}"]`).innerText;
